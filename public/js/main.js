...
var _user$project$Types$Enemy = F4(
	function (a, b, c, d) {
		return {type_: a, level: b, status: c, attributes: d};
	});
var _user$project$Types$Hero = F5(
	function (a, b, c, d, e) {
		return {name: a, $class: b, level: c, status: d, attributes: e};
	});
var _user$project$Types$Status = F3(
	function (a, b, c) {
		return {health: a, mana: b, effects: c};
	});
var _user$project$Types$Attributes = F4(
	function (a, b, c, d) {
		return {damage: a, health: b, speed: c, magic: d};
	});
var _user$project$Types$RangedRange = function (a) {
	return {ctor: 'RangedRange', _0: a};
};
var _user$project$Types$MeleeRange = function (a) {
	return {ctor: 'MeleeRange', _0: a};
};
...
var _user$project$Types$Ranged = function (a) {
	return {ctor: 'Ranged', _0: a};
};
var _user$project$Types$Melee = function (a) {
	return {ctor: 'Melee', _0: a};
};
var _user$project$Types$Rogue = {ctor: 'Rogue'};
var _user$project$Types$Knight = {ctor: 'Knight'};
var _user$project$Types$Axethrower = {ctor: 'Axethrower'};
var _user$project$Types$Ranger = {ctor: 'Ranger'};
var _user$project$Types$Cleric = {ctor: 'Cleric'};
var _user$project$Types$Wizard = {ctor: 'Wizard'};
var _user$project$Types$Dead = {ctor: 'Dead'};
var _user$project$Types$Stunned = {ctor: 'Stunned'};

var _user$project$Context$Context = F3(
	function (a, b, c) {
...
var _user$project$Utilities$initialAttributes = function ($class) {
	var _p0 = $class;
	switch (_p0.ctor) {
		case 'Melee':
			var _p1 = _p0._0;
			if (_p1.ctor === 'Knight') {
				return A4(_user$project$Types$Attributes, 4, 4, 3, 4);
			} else {
				return A4(_user$project$Types$Attributes, 4, 4, 6, 4);
			}
		case 'Ranged':
			var _p2 = _p0._0;
			if (_p2.ctor === 'Ranger') {
				return A4(_user$project$Types$Attributes, 4, 4, 9, 4);
			} else {
...
var _user$project$Utilities$initStatus = function (attributes) {
	return A3(
...
var _user$project$Utilities$getEnemyTypeName = function (enemyType) {
	var _p4 = enemyType;
	if (_p4.ctor === 'MeleeRange') {
		return _elm_lang$core$Basics$toString(_p4._0);
	} else {
		return _elm_lang$core$Basics$toString(_p4._0);
	}
};
var _user$project$Utilities$getSubclassName = function (heroClass) {
	var _p5 = heroClass;
	switch (_p5.ctor) {
		case 'Melee':
...
var _user$project$Utilities$rootImageFilepath = 'public/img/64x64/';
var _user$project$Utilities$getHeroImageFilepath = function (heroClass) {
	var heroFilename = _elm_lang$core$String$toLower(
		_user$project$Utilities$getSubclassName(heroClass));
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$Utilities$getEnemyImageFilepath = function (enemyType) {
	var enemyFilename = _elm_lang$core$String$toLower(
		_user$project$Utilities$getEnemyTypeName(enemyType));
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Utilities$rootImageFilepath,
		A2(
...
var _user$project$Utilities$unpartition = function (_p6) {
	var _p7 = _p6;
	return A2(_elm_lang$core$Basics_ops['++'], _p7._0, _p7._1);
};
...
_user$project$Utilities_ops['!!'] = F2(
	function (model, _p8) {
		var _p9 = _p8;
		return {ctor: '_Tuple3', _0: model, _1: _p9._0, _2: _p9._1};
	});
...
var _user$project$CombatView$viewActorAction = F2(
	function (actorDetails, action) {
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(action.msg),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(action.label),
				_1: {ctor: '[]'}
			});
	});
var _user$project$CombatView$getActions = F2(
	function (actorDetails, clickState) {
		var _p0 = clickState;
		switch (_p0.ctor) {
			case 'Select':
				return actorDetails.selectActions;
			case 'Attack':
				return actorDetails.attackActions;
			case 'Move':
				return actorDetails.moveActions;
			default:
				return {ctor: '[]'};
		}
	});
var _user$project$CombatView$viewActorActions = F2(
	function (actorDetails, clickState) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('actor-actions'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				_user$project$CombatView$viewActorAction(actorDetails),
				A2(_user$project$CombatView$getActions, actorDetails, clickState)));
	});
var _user$project$CombatView$getManaPercent = function (actorDetails) {
	return A2(
		F2(
			function (x, y) {
		...
		_elm_lang$core$Basics$toString(
			A2(
				...
				_elm_lang$core$Basics$toFloat(actorDetails.attributes.magic),
				_elm_lang$core$Basics$toFloat(actorDetails.status.mana))));
};
var _user$project$CombatView$getHealthPercent = function (actorDetails) {
	return A2(
		F2(
			function (x, y) {
				return A2(_elm_lang$core$Basics_ops['++'], x, y);
		...
		_elm_lang$core$Basics$toString(
			A2(
				...
				_elm_lang$core$Basics$toFloat(actorDetails.attributes.health),
				_elm_lang$core$Basics$toFloat(actorDetails.status.health))));
};
var _user$project$CombatView$viewManabar = function (actorDetails) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('status-bar mana'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('available'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'width',
									_1: _user$project$CombatView$getManaPercent(actorDetails)
								},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
...
var _user$project$CombatView$viewHealthbar = function (actorDetails) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('status-bar health'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'width',
									_1: _user$project$CombatView$getHealthPercent(actorDetails)
								},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
...
var _user$project$CombatView$viewActorStatus = function (actorDetails) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('actor-status'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$CombatView$viewHealthbar(actorDetails),
			_1: {
				ctor: '::',
				_0: _user$project$CombatView$viewManabar(actorDetails),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$CombatView$getActorImageFilePath = function (actor) {
	var _p1 = actor.actorType;
	if (_p1.ctor === 'HeroActor') {
		return _user$project$Utilities$getHeroImageFilepath(_p1._0.$class);
	} else {
		return _user$project$Utilities$getEnemyImageFilepath(_p1._0.type_);
	}
};
...
var _user$project$CombatView$viewActorsAt = F2(
	function (coordinates, model) {
		return A2(
			_elm_lang$core$List$map,
			function (actor) {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('actor expandUp'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
			...
			A2(_user$project$CombatView$getActorsAt, coordinates, model));
	});
var _user$project$CombatView$getActorAt = F2(
	function (coordinates, model) {
		return _elm_lang$core$List$head(
			A2(_user$project$CombatView$getActorsAt, coordinates, model));
	});
var _user$project$CombatView$withinDistance = F3(
	function (_p3, _p2, range) {
		var _p4 = _p3;
		var _p9 = _p4._1;
		var _p8 = _p4._0;
		var _p5 = _p2;
		var _p7 = _p5._1;
		var _p6 = _p5._0;
		return (_elm_lang$core$Native_Utils.cmp((_p8 - _p6) * (_p8 - _p6), range * range) < 1) && (_elm_lang$core$Native_Utils.cmp((_p9 - _p7) * (_p9 - _p7), range * range) < 1);
	});
var _user$project$CombatView$getMoveRange = function (speed) {
	return ((speed / 4) | 0) + 1;
};
var _user$project$CombatView$inWalkingRange = F2(
	function (coordinates, actor) {
		var _p10 = actor.actorType;
		if (_p10.ctor === 'HeroActor') {
			return A3(
				_user$project$CombatView$withinDistance,
				actor.coordinates,
				coordinates,
				_user$project$CombatView$getMoveRange(_p10._0.attributes.speed));
		} else {
			return A3(
				_user$project$CombatView$withinDistance,
				actor.coordinates,
...
var _user$project$CombatView$inAttackRange = F2(
	function (coordinates, actor) {
		var _p11 = actor.actorType;
		if (_p11.ctor === 'HeroActor') {
			var _p12 = _p11._0.$class;
			if (_p12.ctor === 'Melee') {
				return A3(_user$project$CombatView$withinDistance, actor.coordinates, coordinates, 1);
			} else {
				return A3(_user$project$CombatView$withinDistance, actor.coordinates, coordinates, 2);
			}
		} else {
			var _p13 = _p11._0.type_;
			if (_p13.ctor === 'MeleeRange') {
				return A3(_user$project$CombatView$withinDistance, actor.coordinates, coordinates, 1);
			} else {
				return A3(_user$project$CombatView$withinDistance, actor.coordinates, coordinates, 2);
			}
...
var _user$project$CombatView$hasSelectedActor = F2(
	function (model, coordinates) {
		var _p14 = model.selectedActor;
		if (_p14.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.eq(coordinates, _p14._0.coordinates);
		} else {
			return false;
		}
	});
var _user$project$CombatView$getStyle = function (_p15) {
	var _p16 = _p15;
	var _p18 = _p16._0;
	var _p17 = _p16._1;
	return (_elm_lang$core$Native_Utils.cmp(_p18, _p17) > 0) ? {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'width',
		...
		_1: {
			...
			_0: {
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(((100 * _p17) / _p18) | 0),
					'vmin')
			},
			_1: {ctor: '[]'}
		}
		...
		_1: {
			...
			_0: {
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(((100 * _p18) / _p17) | 0),
					'vmin')
			},
			_1: {ctor: '[]'}
		}
...
var _user$project$CombatView$getInfoAt = F2(
	function (coordinates, model) {
		return _user$project$Utilities$just(
			_elm_lang$core$Native_Utils.update(
				model,
				{
					selectedActor: A2(_user$project$CombatView$getActorAt, coordinates, model)
				}));
	});
var _user$project$CombatView$update = F2(
	function (msg, model) {
		...
		switch (_p19.ctor) {
			...
			case 'ClickCell':
				var _p20 = model.clickState;
				switch (_p20.ctor) {
					case 'Select':
						return A2(_user$project$CombatView$getInfoAt, _p19._0, model);
					case 'Attack':
						return _user$project$Utilities$just(model);
					case 'Move':
						return _user$project$Utilities$just(model);
...
var _user$project$CombatView$emptyHtml = _elm_lang$html$Html$text('');
var _user$project$CombatView$Actor = F2(
	function (a, b) {
		return {actorType: a, coordinates: b};
	});
var _user$project$CombatView$ActorAction = F2(
	function (a, b) {
		return {label: a, msg: b};
	});
var _user$project$CombatView$ActorDetails = F8(
	function (a, b, c, d, e, f, g, h) {
		return {name: a, level: b, className: c, status: d, attributes: e, selectActions: f, attackActions: g, moveActions: h};
	});
var _user$project$CombatView$Model = F3(
	function (a, b, c) {
		return {actors: a, selectedActor: b, clickState: c};
	});
...
var _user$project$CombatView$initCombatForHero = function (hero) {
	var enemyAttributes = A4(_user$project$Types$Attributes, 4, 4, 4, 4);
	...
	var enemyType = _user$project$Types$MeleeRange(_user$project$Types$Skeleton);
	var enemy = A4(
		_user$project$Types$Enemy,
		enemyType,
		1,
		_user$project$Utilities$initStatus(enemyAttributes),
		enemyAttributes);
	var enemiesActors = {
		ctor: '::',
		_0: A2(
...
var _user$project$CombatView$initActors = function (maybeHero) {
	var _p21 = maybeHero;
	if (_p21.ctor === 'Just') {
		return _user$project$CombatView$initCombatForHero(_p21._0);
	} else {
		return {ctor: '[]'};
	}
};
var _user$project$CombatView$Disabled = {ctor: 'Disabled'};
var _user$project$CombatView$Move = {ctor: 'Move'};
var _user$project$CombatView$isWalkableToSelectedActor = F2(
	function (model, coordinates) {
		var _p22 = model.selectedActor;
		if (_p22.ctor === 'Just') {
			return A2(_user$project$CombatView$inWalkingRange, coordinates, _p22._0) && (_elm_lang$core$Native_Utils.eq(model.clickState, _user$project$CombatView$Move) && _elm_lang$core$Native_Utils.eq(
				A2(_user$project$CombatView$getActorAt, coordinates, model),
				_elm_lang$core$Maybe$Nothing));
		} else {
			return false;
		}
	});
var _user$project$CombatView$Attack = {ctor: 'Attack'};
var _user$project$CombatView$isAttackableBySelectedActor = F2(
	function (model, coordinates) {
		var _p23 = model.selectedActor;
		if (_p23.ctor === 'Just') {
			var _p24 = _p23._0;
			return A2(_user$project$CombatView$inAttackRange, coordinates, _p24) && (_elm_lang$core$Native_Utils.eq(model.clickState, _user$project$CombatView$Attack) && ((!_elm_lang$core$Native_Utils.eq(
				A2(_user$project$CombatView$getActorAt, coordinates, model),
				_elm_lang$core$Maybe$Nothing)) && (!_elm_lang$core$Native_Utils.eq(coordinates, _p24.coordinates))));
		} else {
			return false;
		}
	});
var _user$project$CombatView$Select = {ctor: 'Select'};
var _user$project$CombatView$init = function (context) {
	return A3(
		...
		_elm_lang$core$Maybe$Nothing,
		_user$project$CombatView$Select);
};
var _user$project$CombatView$SetClickState = function (a) {
	return {ctor: 'SetClickState', _0: a};
};
var _user$project$CombatView$getActorDetails = function (actor) {
	var _p25 = actor.actorType;
	if (_p25.ctor === 'HeroActor') {
		var _p26 = _p25._0;
		return A8(
			_user$project$CombatView$ActorDetails,
			_p26.name,
			_p26.level,
			_user$project$Utilities$getSubclassName(_p26.$class),
			_p26.status,
			_p26.attributes,
			{
				ctor: '::',
				_0: A2(
					_user$project$CombatView$ActorAction,
					'Attack',
					_user$project$CombatView$SetClickState(_user$project$CombatView$Attack)),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$CombatView$ActorAction,
						'Move',
						_user$project$CombatView$SetClickState(_user$project$CombatView$Move)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					_user$project$CombatView$ActorAction,
					'Cancel',
					_user$project$CombatView$SetClickState(_user$project$CombatView$Select)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		return A8(
			_user$project$CombatView$ActorDetails,
			_user$project$Utilities$getEnemyTypeName(_p27.type_),
			_p27.level,
			_user$project$Utilities$getEnemyTypeName(_p27.type_),
			_p27.status,
			_p27.attributes,
...
var _user$project$CombatView$viewActorDetails = function (model) {
	var _p28 = A2(_elm_lang$core$Maybe$map, _user$project$CombatView$getActorDetails, model.selectedActor);
	if (_p28.ctor === 'Just') {
		var _p29 = _p28._0;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('actor-details'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(_p29.level),
										A2(_elm_lang$core$Basics_ops['++'], ' ', _p29.className)))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$CombatView$viewActorStatus(_p29),
						_1: {
							ctor: '::',
							_0: A2(_user$project$CombatView$viewActorActions, _p29, model.clickState),
							_1: {ctor: '[]'}
						}
					}
				}
		...
		return _user$project$CombatView$emptyHtml;
	}
};
var _user$project$CombatView$ClickCell = function (a) {
	return {ctor: 'ClickCell', _0: a};
};
var _user$project$CombatView$viewCombatBoardCell = F3(
	function (model, x, y) {
		var actors = A2(
			_user$project$CombatView$viewActorsAt,
			{ctor: '_Tuple2', _0: x, _1: y},
			model);
		var walkableClass = A2(
			_user$project$CombatView$isWalkableToSelectedActor,
			model,
			{ctor: '_Tuple2', _0: x, _1: y}) ? 'walkable' : '';
		var attackableClass = A2(
			_user$project$CombatView$isAttackableBySelectedActor,
			model,
			{ctor: '_Tuple2', _0: x, _1: y}) ? 'attackable' : '';
		var coordinates = {ctor: '_Tuple2', _0: x, _1: y};
		var selectedClass = A2(_user$project$CombatView$hasSelectedActor, model, coordinates) ? 'selected' : '';
		var classes = A2(
			_elm_lang$core$List$filter,
			function (str) {
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$CombatView$ClickCell(
							{ctor: '_Tuple2', _0: x, _1: y})),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('actors floating'),
						_1: {ctor: '[]'}
					},
					actors),
				_1: {ctor: '[]'}
...
var _user$project$CombatView$viewCombatBoard = function (model) {
	var _p30 = _user$project$CombatView$boardDimensions;
	var numRows = _p30._0;
	var numCols = _p30._1;
	var rows = A2(
		_elm_lang$core$List$map,
...
var _user$project$CombatView$view = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$CombatView$viewActorDetails(model),
				_1: {ctor: '[]'}
			}
		});
};
		...
		if (_p5.ctor === 'Just') {
			...
			return _elm_lang$core$Maybe$Just(
				A5(
					...
					_user$project$Utilities$initStatus(
						_user$project$Utilities$initialAttributes(_p6)),
					_user$project$Utilities$initialAttributes(_p6)));
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
			...
			case 'MainClassSelected':
				return _user$project$Utilities$just(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							heroClass: _elm_lang$core$Maybe$Just(_p10._0)
						}));
			...
			case 'NameChanged':
				return _user$project$Utilities$just(
					_elm_lang$core$Native_Utils.update(
						...
						{heroName: _p10._0}));
			default:
				var _p11 = _user$project$HeroCreate$getHero(model);
				if (_p11.ctor === 'Just') {
					return {
						ctor: '_Tuple3',
						_0: model,
						_1: _elm_lang$core$Platform_Cmd$none,
						_2: _user$project$Utilities$getCmd(
							_user$project$Context$AddHero(_p11._0))
					};
				} else {
					var _p12 = _elm_lang$core$Debug$log('Hero could not be created...');
					return _user$project$Utilities$just(model);
				}
		}
	});
		...
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						function () {
							var _p18 = _user$project$HeroCreate$getCreateStep(model);
							switch (_p18.ctor) {
...
var _user$project$HeroCreate$viewBackButton = function (model) {
	var onClickMsg = function () {
		var _p19 = _user$project$HeroCreate$getCreateStep(model);
		switch (_p19.ctor) {
			case 'HasNothingSelected':
...
var _user$project$HeroCreate$magicSubclassOptions = {
	...
	_1: {
		...
		_0: A2(
			_user$project$HeroCreate$ClassOption,
			'Cleric',
			_user$project$HeroCreate$MagicSubclassSelected(_user$project$Types$Cleric)),
		_1: {ctor: '[]'}
	}
};
...
var _user$project$HeroCreate$viewSubclassOptions = function (model) {
	var _p20 = _user$project$HeroCreate$getEmptyMainClass(model.heroClass);
	switch (_p20.ctor) {
		case 'AlmostMelee':
...
var _user$project$HeroCreate$NoOp = {ctor: 'NoOp'};
var _user$project$HeroCreate$viewNameOptions = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(_user$project$HeroCreate$NoOp),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$HeroCreate$viewOptions = function (model) {
	return A2(
		...
		function () {
			var _p21 = _user$project$HeroCreate$getCreateStep(model);
			switch (_p21.ctor) {
				case 'HasNothingSelected':
					return {
						ctor: '::',
						_0: _user$project$HeroCreate$viewMainClassOptions(model),
						_1: {ctor: '[]'}
					};
				case 'HasMainClassSelected':
					return {
						ctor: '::',
						_0: _user$project$HeroCreate$viewSubclassOptions(model),
						_1: {ctor: '[]'}
					};
				default:
					return {
						ctor: '::',
						_0: _user$project$HeroCreate$viewHeroImage(model),
						_1: {
							ctor: '::',
							_0: _user$project$HeroCreate$viewNameOptions(model),
							_1: {ctor: '[]'}
						}
					};
			}
...
var _user$project$HeroCreate$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('hero-create'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MainMenu$viewMenuButton = function (menuButton) {
	return A2(
		_elm_lang$html$Html$button,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(menuButton.onClick),
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(menuButton.label),
			_1: {ctor: '[]'}
		});
};
var _user$project$MainMenu$viewMenuButtons = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$MainMenu$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('main-menu container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MainMenu$MenuButton = F2(
	function (a, b) {
		return {label: a, onClick: b};
	});
var _user$project$MainMenu$Model = F2(
	function (a, b) {
	...
	var heroButtons = A2(
		...
		_user$project$Utilities$unpartition(
			A2(
				...
				context.heroes)));
	return A2(_elm_lang$core$Basics_ops['++'], heroButtons, _user$project$MainMenu$initialButtons);
};
...
var _user$project$Main$updateMainMenuPageModel = F2(
	function (model, pageModels) {
		return _elm_lang$core$Native_Utils.update(
			pageModels,
			{mainMenu: model});
...
var _user$project$Main$initContext = A3(
	_user$project$Context$Context,
	_elm_lang$core$Maybe$Nothing,
	{ctor: '[]'},
	_user$project$Context$MainMenu);
...
var _user$project$Main$init = function () {
	var model = A2(
		...
		_user$project$Main$initContext,
		_user$project$Main$initPageModels(_user$project$Main$initContext));
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		model,
		{ctor: '[]'});
...
var _user$project$Main$MainMenuMsg = function (a) {
	return {ctor: 'MainMenuMsg', _0: a};
};
...
var _user$project$Main$ContextMsg = function (a) {
	return {ctor: 'ContextMsg', _0: a};
};
var _user$project$Main$localUpdate = F4(
	function (_p2, msgFunc, pageModelsUpdater, model) {
		var _p3 = _p2;
		var pageModels = A2(pageModelsUpdater, _p3._0, model.pageModels);
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Native_Utils.update(
				model,
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, msgFunc, _p3._1),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ContextMsg, _p3._2),
					_1: {ctor: '[]'}
				}
			});
	});
		...
		switch (_p4.ctor) {
			...
			case 'MainMenuMsg':
				return A4(
					...
					A2(_user$project$MainMenu$update, _p4._0, model.pageModels.mainMenu),
					_user$project$Main$MainMenuMsg,
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"CombatView.ClickState":{"args":[],"tags":{"Disabled":[],"Select":[],"Attack":[],"Move":[]}},"Context.Page":{"args":[],"tags":{"MainMenu":[],"CombatView":[],"HeroCreate":[]}},"Types.MeleeSubclass":{"args":[],"tags":{"Knight":[],"Rogue":[]}},"HeroCreate.Msg":{"args":[],"tags":{"MagicSubclassSelected":["Types.MagicSubclass"],"NameChanged":["String"],"GoToMainMenu":[],"CreateHero":[],"MainClassSelected":["HeroCreate.MainClass"],"MeleeSubclassSelected":["Types.MeleeSubclass"],"SubclassReset":[],"MainClassReset":[],"RangedSubclassSelected":["Types.RangedSubclass"],"NoOp":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Types.MagicSubclass":{"args":[],"tags":{"Cleric":[],"Wizard":[]}},"CombatView.Msg":{"args":[],"tags":{"GoToMainMenu":[],"SetClickState":["CombatView.ClickState"],"ClickCell":["CombatView.Coordinates"],"NoOp":[]}},"Types.RangedSubclass":{"args":[],"tags":{"Axethrower":[],"Ranger":[]}},"Main.Msg":{"args":[],"tags":{"ContextMsg":["Context.Msg"],"MainMenuMsg":["MainMenu.Msg"],"CombatViewMsg":["CombatView.Msg"],"HeroCreateMsg":["HeroCreate.Msg"]}},"MainMenu.Msg":{"args":[],"tags":{"CreateHeroClicked":[],"PlayAs":["Types.Hero"]}},"HeroCreate.MainClass":{"args":[],"tags":{"AlmostMagic":["Maybe.Maybe Types.MagicSubclass"],"AlmostMelee":["Maybe.Maybe Types.MeleeSubclass"],"AlmostRanged":["Maybe.Maybe Types.RangedSubclass"]}},"Context.Msg":{"args":[],"tags":{"GotoPage":["Context.Page"],"InitPage":["Context.Page"],"AddHero":["Types.Hero"],"PlayAs":["Types.Hero"]}},"Types.HeroClass":{"args":[],"tags":{"Magic":["Types.MagicSubclass"],"Melee":["Types.MeleeSubclass"],"Ranged":["Types.RangedSubclass"]}},"Types.StatusEffect":{"args":[],"tags":{"Dead":[],"Stunned":[]}}},"aliases":{"Types.Hero":{"args":[],"type":"{ name : String , class : Types.HeroClass , level : Int , status : Types.Status , attributes : Types.Attributes }"},"Types.Status":{"args":[],"type":"{ health : Int, mana : Int, effects : List Types.StatusEffect }"},"CombatView.Coordinates":{"args":[],"type":"( Int, Int )"},"Types.Attributes":{"args":[],"type":"{ damage : Int, health : Int, speed : Int, magic : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
